...
public class Juego extends InterfaceJuego {
	...
	private int cooldownPlant = 0;
	private int cooldownNuez = 0;
	...
	private Zombie z;
	private int alphaPlanta;
	private int alphaNuez;
	...
	public void tick() {
		...
		for (int i = 0; i < plantas.length; i++) {
			if (plantas[i] != null) {
				...
				if (cooldownPlant == 0 && entorno.sePresionoBoton(entorno.BOTON_IZQUIERDO)
		...
		Color plantaCool = new Color(128, 128, 128, alphaPlanta);

		alphaPlanta = cooldownPlant;
		entorno.dibujarRectangulo(80, 80, 80, 100, 0, plantaCool);
		...
		for (int i = 0; i < nuez.length; i++) {
			...
			if (n != null) {
				...
				if (cooldownNuez == 0 && entorno.sePresionoBoton(entorno.BOTON_IZQUIERDO)
		...
		Color nuezCool = new Color(128, 128, 128, alphaNuez);

		alphaNuez = cooldownNuez;
		entorno.dibujarRectangulo(160, 80, 80, 100, 0, nuezCool);
